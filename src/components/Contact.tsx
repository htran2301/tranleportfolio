      ...
      <div className="container-custom">
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="space-y-6">
            <ScrollAnimation delay={0.1} className="text-center">
              <h3 className="font-display font-semibold text-xl text-primary mb-4">
                Contact Information
              </h3>
              <p className="text-muted-foreground mb-8">I'm actively seeking a full-time role starting after December 15, 2026 (my graduation) in Data Analytics, Data Science, and Data Engineering. Let's connect!</p>
            </ScrollAnimation>
